...
import {updateUserAct, userByIdAct} from "@/app/[locale]/(private)/account/actions";
...
export default function AccountSettings() {
    ...
    const handleSave = async () => {
        ...
        try {
            const updated = await updateUserAct(account);
    ...
    const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onloadend = async () => {
            ...
            try {
                if (account) {
                    await updateUserAct({...account, img_base64: base64});
                    toast.success(t("avatarSuccess"));
                }
            } catch (err: any) {
                console.error("Error updating avatar:", err);
                toast.error(t("avatarError"), {description: err.message});
            }
        };
    ...
    if (!account) return <div>{t("notFound")}</div>;
                    ...
                    <CardContent className="pb-6">
                        ...
                        <TabsContent value="account" className="space-y-6">
                            ...
                            <div className="grid gap-6 lg:grid-cols-2">
                                ...
                                <Card>
                                    <CardHeader>
                                        <CardTitle className="text-lg font-semibold text-gray-800">{t("changeProfileTitle")}</CardTitle>
                                        <p className="text-sm text-gray-500">{t("changeProfileDesc")}</p>
                                    </CardHeader>
                                        ...
                                        <div className="w-24 h-24 rounded-full overflow-hidden bg-blue-100">
                                            <Avatar
                                                ...
                                                <AvatarImage
                                                    ...
                                                    src={account.img_base64 || undefined}
                                                    alt="Colm Tuite"
                                                />
                                        ...
                                        <div className="flex space-x-3">
                                            ...
                                            <Button variant="destructive"
                                                    ...
                                                    onClick={async () => {
                                                        ...
                                                        if (account) await updateUserAct({
                                                            ...account,
                                                            img_base64: ""
                                                        });
                                                    }}>
...
*/}
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle className="text-lg font-semibold text-gray-800">{t("personalDetailsTitle")}</CardTitle>
                                    <p className="text-sm text-gray-500">{t("personalDetailsDesc")}</p>
                                </CardHeader>
                                <CardContent>
                                    <div className="grid gap-6 lg:grid-cols-2">
                                        <div className="space-y-2">
