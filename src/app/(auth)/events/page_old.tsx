...
import EventCard_old from "@/components/event/EventCard_old";
import EventPast_old from "@/components/event/EventPast_old";
                    ...
                    <TabsContent value="upcoming" className="pl-7 pr-7">
                        {upcoming.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-6">
                                {upcoming.map((ev) => (
                                    <EventCard_old key={ev.id} event={ev}/>
                                ))}
                            </div>
                        )}
                    </TabsContent>
