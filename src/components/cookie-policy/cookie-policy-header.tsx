        ...
        <div className="pb-[25px]">
            <div>
                <h1 className="text-[19px] text-[#262626] mb-[5px]">
                    Cookie Policy di Verona Running
                </h1>
                <div className="text-sm">
                    <p className="mb-4">
                        ...
                        dell’Utente quando quest’ultimo interagisce con questo Sito Web.
                    </p>
                    <p className="mb-4">
                        ...
                        mobili, sarebbe fuori luogo parlare di Cookie nel contesto di
                        applicazioni per dispositivi mobili, dal momento che si tratta di
                        Strumenti di Tracciamento che richiedono la presenza di un browser. Per
                        questo motivo, all’interno di questo documento il termine Cookie è
                        utilizzato solo per indicare in modo specifico quel particolare tipo di
                        Strumento di Tracciamento.
                    </p>
                    <p className="mb-4">
                        Alcune delle finalità per le quali vengono impiegati Strumenti di
                        Tracciamento potrebbero, inoltre, a seconda della legge applicabile
                        richiedere il consenso dell’Utente. Se viene prestato il consenso, esso
                        può essere revocato liberamente in qualsiasi momento seguendo le
                        istruzioni contenute in questo documento.
                    </p>
                    <p>
                        Questo Sito Web utilizza solo Strumenti di Tracciamento gestiti
                        ...
                        Tracciamento simili possono variare a seconda di quanto impostato dal
                        Titolare. Alcuni di essi scadono al termine della sessione di
