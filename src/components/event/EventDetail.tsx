...
import {formatDateLong, formatTimeShort, timeRemaining} from "@/lib/datetime_utils";
import {useTranslations} from "next-intl";

export default function EventDetail({event}: { event: EventWithRegistration }) {
    const t = useTranslations("event.eventDetail");
...
*/}
                ...
                {/* About */}
                <div className="mt-8 md:mt-10">
                    <h2 className="text-base font-semibold text-foreground mb-3">{t("about")}</h2>
